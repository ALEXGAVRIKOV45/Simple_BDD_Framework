...
public class WebActionSteps {
	...
	@Если("навести на элемент {string}")
	public void hoverOnElement(String elementName) {
		SelenideElement element = pageManager
				.getCurrentPage()
				.getElement(elementName);
		element
				.hover();
		LOGGER.info("навести на элемент '{}'", elementName);
	}

	@Если("перейти на элемент {string}")
	public void moveToElement(String elementName) {
		...
		LOGGER.info("move на элемент '{}'", elementName);
	}
	...
	@Если("особый кликнуть на элемент {string}")
	public void clickOnElementAlex(String elementName) throws InterruptedException {
		SelenideElement element = pageManager
				.getCurrentPage()
				.getElement(elementName);
		element
	...
	public void clearFiled(String elementName) {
		...
		LOGGER.info("поле очищено '{}'", elementName);
	}
	 ...
	 * @param elementName наименование элемента
	 */
	@Если("удалить символы {string}")
	public void clearFiledBS(String elementName) {
		pageManager
				.getCurrentPage()
				.getElement(elementName)
				.shouldBe(Condition.visible, Duration.ofSeconds(3))
		...
		LOGGER.info("сиволы удалены '{}'", elementName);
	}
